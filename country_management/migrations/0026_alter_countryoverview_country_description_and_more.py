...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('country_management', '0025_alter_countryoverview_country_description_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            field=markdownx.models.MarkdownxField(help_text="Detail the optional employee benefits commonly offered by employers in [Country]. Integrate relevant references into the content for factual support. Return in markdown, start with H2 headings and use H3, H4 if needed. Only return the guide and do not add disclaimers. Don't add invalid URL's"),
        ),
        migrations.AlterField(
            model_name='employeebenefitsandentitlements',
            name='retirement_plans',
            field=markdownx.models.MarkdownxField(help_text="Explore the retirement plans available to employees in [Country]. Incorporate authoritative references to support the discussion. Return in markdown, start with H2 headings and use H3, H4 if needed. Only return the guide and do not add disclaimers. Don't add invalid URL's"),
        ),
        migrations.AlterField(
            model_name='employmentagreements',
            name='confidentiality_and_non_compete_clauses',
            field=markdownx.models.MarkdownxField(help_text="Discuss the confidentiality and non-compete clauses in employment agreements in [Country]. Seamlessly integrate relevant legal sources within the text. Return in markdown, start with H2 headings and use H3, H4 if needed. Only return the guide and do not add disclaimers. Don't add invalid URL's"),
        ),
        migrations.AlterField(
            model_name='employmentagreements',
            name='essential_clauses',
            field=markdownx.models.MarkdownxField(help_text="Examine the essential clauses that should be included in employment agreements in [Country]. Embed authoritative references to support the discussion. Return in markdown, start with H2 headings and use H3, H4 if needed. Only return the guide and do not add disclaimers. Don't add invalid URL's"),
        ),
        migrations.AlterField(
            model_name='employmentagreements',
            name='probationary_period',
            field=markdownx.models.MarkdownxField(help_text="Explore the concept of the probationary period in employment agreements in [Country]. Incorporate credible sources directly into the guide for validation. Return in markdown, start with H2 headings and use H3, H4 if needed. Only return the guide and do not add disclaimers. Don't add invalid URL's"),
        ),
        migrations.AlterField(
            model_name='employmentagreements',
        ...
        migrations.AlterField(
            ...
            field=markdownx.models.MarkdownxField(help_text="Provide an in-depth overview of health and safety laws in [Country]. Embed relevant legal references within the text for accuracy. Return in markdown, start with H2 headings and use H3, H4 if needed. Only return the guide and do not add disclaimers. Don't add invalid URL's"),
        ),
        migrations.AlterField(
            model_name='healthandsafetyrequirements',
        ...
        migrations.AlterField(
            ...
            field=markdownx.models.MarkdownxField(help_text="Explore the variety of bonuses and allowances offered to employees in [Country]. Incorporate credible sources directly into the guide for validation. Return in markdown, start with H2 headings and use H3, H4 if needed. Only return the guide and do not add disclaimers. Don't add invalid URL's"),
        ),
        migrations.AlterField(
            model_name='salaryandcompensation',
        ...
        migrations.AlterField(
            model_name='salaryandcompensation',
            name='minimum_wage',
            field=markdownx.models.MarkdownxField(help_text="Detail the minimum wage regulations in [Country]. Embed relevant legislative references to ensure accuracy. Return in markdown, start with H2 headings and use H3, H4 if needed. Only return the guide and do not add disclaimers. Don't add invalid URL's"),
        ),
        migrations.AlterField(
            model_name='salaryandcompensation',
            name='payroll_cycle',
            field=markdownx.models.MarkdownxField(help_text="Examine the payroll cycle practices in [Country]. Seamlessly integrate authoritative financial and legal references within the text. Return in markdown, start with H2 headings and use H3, H4 if needed. Only return the guide and do not add disclaimers. Don't add invalid URL's"),
        ),
        migrations.AlterField(
            model_name='standardworkinghoursandovertime',
            name='night_shift_and_weekend_regulations',
            field=markdownx.models.MarkdownxField(help_text="Discuss the specific regulations for night shift and weekend work in [Country]. Seamlessly integrate applicable legal references within the text. Return in markdown, start with H2 headings and use H3, H4 if needed. Only return the guide and do not add disclaimers. Don't add invalid URL's"),
        ),
        migrations.AlterField(
            model_name='standardworkinghoursandovertime',
            name='overtime',
            field=markdownx.models.MarkdownxField(help_text="Detail the rules and compensation for overtime work in [Country]. Embed relevant legislation and guidelines to ensure accuracy. Return in markdown, start with H2 headings and use H3, H4 if needed. Only return the guide and do not add disclaimers. Don't add invalid URL's"),
        ),
        migrations.AlterField(
            model_name='standardworkinghoursandovertime',
            name='rest_periods_and_breaks',
            field=markdownx.models.MarkdownxField(help_text="Examine the entitlements to rest periods and breaks for workers in [Country]. Incorporate authoritative sources directly into the guide for verification. Return in markdown, start with H2 headings and use H3, H4 if needed. Only return the guide and do not add disclaimers. Don't add invalid URL's"),
        ),
        migrations.AlterField(
            model_name='standardworkinghoursandovertime',
        ...
        migrations.AlterField(
            ...
            field=markdownx.models.MarkdownxField(help_text="Detail the employee tax deductions in [Country]. Embed relevant references within the text to enhance credibility. Return in markdown, start with H2 headings and use H3, H4 if needed. Only return the guide and do not add disclaimers. Don't add invalid URL's"),
        ),
        migrations.AlterField(
            model_name='taxobligations',
            name='employer_tax_responsibilites',
            field=markdownx.models.MarkdownxField(help_text="Outline the employer tax responsibilities in [Country]. Ensure authoritative resources are integrated within the guide to provide verification. Return in markdown, start with H2 headings and use H3, H4 if needed. Only return the guide and do not add disclaimers. Don't add invalid URL's"),
        ),
        migrations.AlterField(
            model_name='taxobligations',
            name='tax_incentives',
            field=markdownx.models.MarkdownxField(help_text="Explore the tax incentives available to businesses in [Country]. Incorporate relevant sources within the guide for factual accuracy. Return in markdown, start with H2 headings and use H3, H4 if needed. Only return the guide and do not add disclaimers. Don't add invalid URL's"),
        ),
        migrations.AlterField(
            model_name='taxobligations',
            name='vat',
            field=markdownx.models.MarkdownxField(help_text="Examine the Value-Added Tax (VAT) implications for services in [Country]. Integrate authoritative sources directly into the content for substantiation. Return in markdown, start with H2 headings and use H3, H4 if needed. Only return the guide and do not add disclaimers. Don't add invalid URL's"),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            model_name='termination',
            name='severance_pay',
            field=markdownx.models.MarkdownxField(help_text="Detail the severance pay entitlements in [Country]. Incorporate authoritative legal sources to substantiate the information presented. Return in markdown, start with H2 headings and use H3, H4 if needed. Only return the guide and do not add disclaimers. Don't add invalid URL's"),
        ),
        migrations.AlterField(
            model_name='termination',
        ...
        migrations.AlterField(
            ...
            name='holiday_leave',
            field=markdownx.models.MarkdownxField(help_text="Detail the vacation leave entitlements in [Country]. Integrate relevant labor laws and guidelines within the text to lend authority. Return in markdown, start with H2 headings and use H3, H4 if needed. Only return the guide and do not add disclaimers. Don't add invalid URL's"),
        ),
        migrations.AlterField(
            model_name='vacationandleavepolicies',
            name='public_holidays',
            field=markdownx.models.MarkdownxField(help_text="Explore the public holidays observed in [Country]. Embed authoritative sources to validate the information. Return in markdown, start with H2 headings and use H3, H4 if needed. Only return the guide and do not add disclaimers. Don't add invalid URL's"),
        ),
        migrations.AlterField(
            model_name='vacationandleavepolicies',
            name='types_of_leave',
